...
import type { SingleFilePipe } from "./pipes/single"
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import type { FileArrayPipe } from "./pipes/array"
 ...
 *   * {@link SingleFilePipe} for keeping a reference to a single item.
 *   * {@link FileArrayPipe} for collecting multiple items into an array.
 *
